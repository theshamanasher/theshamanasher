                ...
                <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
                    ...
                    <li className="relative group">
                        ...
                        <ul className="absolute hidden group-hover:block bg-main-bg shadow-lg rounded py-1 top-full left-0 w-[300px] border-l border-l-text-main border-b border-b-text-main border-r border-r-text-main z-30">
                            <li><a className="block px-4 py-2 text-sm text-main-text hover:text-gray-500" href="/services/chakra-alignment" >Chakra Alignment</a></li>
                            ...
                            <li><a className="block px-4 py-2 text-sm text-main-text hover:text-gray-500" href="/services/cleansing-and-protection">Smudging - Cleansing Renewing Protecting</a></li>
